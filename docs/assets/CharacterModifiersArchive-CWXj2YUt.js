...
恢复 Sanity 不会自动删除已有疯狂。`,acquisition:`Sanity 降到 0 时，由人物的疯狂判定产生。`},{id:`character-base-temporary-divineentity`,source:`base`,sourceName:`游戏本体`,name:`Divine Blessing`,category:`player`,eligible:`被 Divine Entity 奖励选中的玩家 Agent`,text:`Intrigue、Lore、Command 各 +1。`,acquisition:`满足 Divine Entity 的愿望后，随机奖励选择 Blessing；从尚未持有临时 Command 特质的玩家 Agent 中选取一人。`,duration:`27 回合。`},{id:`character-base-event-injury`,source:`base`,sourceName:`游戏本体`,name:`Injury`,category:`mobile`,eligible:`对应事件及选项指定的角色`,text:`<CrossReference name="The young of the serpent" href="?page=events#entry-event-base-fog-exploreruins-infil3" meta="事件" text="完成 Explore Ruins 后，在符合条件的遗迹探索事件中抽取。
...
单次候选检查概率：100%。" /> 的对应选项获得。`,duration:`各项从获得时分别倒计时，持续回合见上；到期移除对应属性变化。`},{id:`character-3261852980-event-nobleconnections`,source:`3261852980`,sourceName:`Event Pack Redux`,name:`Noble Connections`,category:`player`,eligible:`满足事件条件的 Human、Elf 或 Orc 玩家 Agent`,text:`在 City 执行行动时 Security −1。`,acquisition:`Noble Connections 事件选择 Hand the social climber the ladder。事件要求当地有对该人物持正面态度的统治者、Agent 的 Menace <20，且本局尚未通过此事件获得。`}],m=u(),h=Array.from(new Set(p.map(e=>e.source))).map(e=>({id:e,name:p.find(t=>t.source===e).sourceName,groups:Object.entries(f).map(([t,n])=>({id:`characters-`+e+`-`+t,name:n,items:p.filter(n=>n.source===e&&n.category===t)})).filter(e=>e.items.length)})),g={id:`character-modifiers`,assetDir:``,autoLink:!1,powers:[],sections:h.flatMap(e=>e.groups.map(e=>({id:e.id,title:`角色特质`,items:e.items})))},_=p.map(e=>`entry-`+e.id),v=h.map(e=>({name:e.name,entries:e.groups.map(e=>({href:`#`+e.id,label:e.name}))})),y=p.filter(e=>e.source===`base`).length;function b(){let{sidebarHidden:n,setSidebarHidden:u,closeMobileSidebar:f,onSidebarClick:b}=l(),[x,S]=(0,d.useState)(new Set),C=e=>S(t=>new Set(t).add(e)),w=e=>S(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n}),T=s(C);return(0,m.jsxs)(`main`,{className:`site-shell base-modifiers-theme character-modifiers-theme`+(n?` sidebar-hidden`:``),onClick:T,children:[(0,m.jsx)(e,{hidden:n,onClose:f}),(0,m.jsxs)(`aside`,{className:`sidebar`,onClick:b,children:[(0,m.jsxs)(`div`,{className:`sidebar-head`,children:[(0,m.jsxs)(`div`,{className:`sidebar-brand`,children:[(0,m.jsx)(`span`,{className:`brand-mark`,children:(0,m.jsx)(a,{size:17})}),(0,m.jsxs)(`span`,{children:[(0,m.jsx)(`b`,{children:`角色特质`}),(0,m.jsx)(`small`,{children:`其他信息`})]})]}),(0,m.jsx)(`button`,{className:`sidebar-toggle`,type:`button`,"aria-expanded":!n,"aria-label":n?`展开侧边栏`:`收起侧边栏`,onClick:()=>u(e=>!e),children:n?(0,m.jsx)(r,{size:17}):(0,m.jsx)(i,{size:17})})]}),(0,m.jsx)(`a`,{className:`sidebar-index-link`,href:`./`,children:`← 返回索引页`}),(0,m.jsxs)(`div`,{className:`sidebar-bulk`,children:[(0,m.jsx)(`button`,{type:`button`,onClick:()=>S(new Set(_)),children:`全部展开`}),(0,m.jsx)(`button`,{type:`button`,onClick:()=>S(new Set),children:`全部收起`})]}),(0,m.jsx)(c,{groups:v,label:`角色特质导航`})]}),(0,m.jsxs)(`div`,{className:`content-shell`,children:[(0,m.jsxs)(`header`,{id:`top`,className:`modifier-library-header`,children:[(0,m.jsx)(`h1`,{children:`角色特质`}),(0,m.jsxs)(`p`,{children:[`本体 `,y,` 项，Mod `,p.length-y,` 项。收录人物的可学习能力、特质、诅咒、临时状态，按能够获得它们的单位类别分类。`]}),(0,m.jsx)(`p`,{children:`不收录神祇相关特质、随从特质及单个玩家 Agent 独有的能力。各 Mod 分别列出，使用当前有效版本。`})]}),h.map((e,n)=>(0,m.jsxs)(`section`,{className:`section character-source`,id:`character-source-`+e.id,children:[(0,m.jsxs)(`div`,{className:`plain-heading`,children:[(0,m.jsxs)(`p`,{className:`section-index`,children:[String(n+1).padStart(2,`0`),` / `,e.id===`base`?`游戏本体`:`Mod`]}),(0,m.jsx)(`h2`,{children:e.name})]}),e.groups.map(e=>(0,m.jsxs)(`div`,{className:`character-category`,id:e.id,children:[(0,m.jsxs)(`h3`,{children:[e.name,(0,m.jsx)(`small`,{children:e.items.length})]}),(0,m.jsx)(`div`,{className:`expandable-table`,children:e.items.map(e=>{let n=`entry-`+e.id;return(0,m.jsxs)(o,{config:g,entryId:n,name:e.name,open:x.has(n),onToggle:w,children:[e.levels&&(0,m.jsxs)(`small`,{className:`tenet-range`,children:[`等级范围：`,e.levels]}),(0,m.jsxs)(`div`,{className:`expanded-section`,children:[(0,m.jsx)(`h4`,{children:`适用人物`}),(0,m.jsx)(`p`,{children:(0,m.jsx)(t,{config:g,text:e.eligible,exclude:e.name})})]}),(0,m.jsxs)(`div`,{className:`expanded-section`,children:[(0,m.jsx)(`h4`,{children:`作用`}),(0,m.jsx)(`p`,{children:(0,m.jsx)(t,{config:g,text:e.text,exclude:e.name})})]}),(0,m.jsxs)(`div`,{className:`expanded-section`,children:[(0,m.jsx)(`h4`,{children:`获取方式`}),(0,m.jsx)(`p`,{children:(0,m.jsx)(t,{config:g,text:e.acquisition,exclude:e.name})})]}),e.duration&&(0,m.jsxs)(`div`,{className:`expanded-section`,children:[(0,m.jsx)(`h4`,{children:`持续与移除`}),(0,m.jsx)(`p`,{children:(0,m.jsx)(t,{config:g,text:e.duration,exclude:e.name})})]})]},n)})})]},e.id))]},e.id)),(0,m.jsx)(`footer`,{className:`archive-footer`,children:(0,m.jsx)(`a`,{className:`sidebar-index-link`,href:`./`,children:`← 返回索引页`})})]})]})}export{b as default};