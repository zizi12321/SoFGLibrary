import{_ as e,c as t,g as n,h as r,l as i,m as a,n as o,p as s,t as c,u as l}from"./index-K3M4Hgiz.js";var u=e(),d=[{id:`place-model`,name:`地点、兴趣点与行动入口`,text:`地点是地图上的聚居地或野外地点载体；兴趣点是附加在地点内的具体设施。
...
Temple 是教团设施，Holy Site 是可被亵渎的圣所，二者也不是同一兴趣点。`,baseGame:!0}],f=[{id:`places-base`,title:`游戏本体`,description:`包含人类、精灵、矮人、Orc、Deep Ones、奇观，以及本体神祇相关地点。`,sections:[{id:`places-base-location`,title:`地点`,items:[{id:`location-set-city`,name:`City`,text:`城市的名称与规模随人口、所属文化及现有兴趣点变化；Town、City 等显示名并非各自独立的地点类型。常规防御上限为人口 × Prosperity，再加各兴趣点的防御加成。
...
挑战：
<CrossReference name="Fund Eternal City" href="#entry-place-task-2866026291-ch-fundcrypt" />`,image:`/locations/mod/kingOfCups.crypt_loc.png`,baseGame:!1}]},{id:`places-2866026291-interest`,title:`兴趣点`,items:[{id:`location-sub-cryptunderbelly`,name:`Crypt Depths`,text:`<CrossReference name="Eternal City" href="#entry-location-set-crypt" /> 的地下设施；代码将其作为独立 Subsettlement 创建。
...
Profile: 100
Menace: 0
XP: 16`,positiveTags:`Shadow`,negativeTags:`无`}]}]},{id:`places-2932765110`,title:`Covens, Curses & Curios Recast`,description:``,sections:[{id:`places-2932765110-extensions`,title:`对已有地点与兴趣点的扩展`,items:[{id:`place-hook-2932765110-0`,name:`Catacombs 的掘墓行动`,text:`Covens, Covens, Covens 在合格人类聚居地的 <CrossReference name="Catacombs" href="#entry-location-sub-catacombs" /> 加入。
...
由具体的 Villikos 占领地点继承，不单独作为地图地点生成。`,meta:`未找到正常生成路径`}]}]}],p=n(),m={id:`locations`,assetDir:`locations`,autoLink:!1,powers:[],sections:[{id:`place-guide`,title:`地点机制`,items:d},...f.flatMap(e=>e.sections)]},h=m.sections.flatMap(e=>e.items.map(e=>`entry-`+e.id)),g=[{name:`阅读说明`,entries:[{href:`#place-guide`,label:`地点与兴趣点`}]},...f.map(e=>({name:e.title,entries:e.sections.map(e=>({href:`#`+e.id,label:e.title}))}))];function _({onReturn:e}){let{sidebarHidden:n,setSidebarHidden:_,closeMobileSidebar:v,onSidebarClick:y}=r(),[b,x]=(0,u.useState)(new Set),S=e=>x(t=>new Set(t).add(e)),C=e=>x(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n}),w=s(S);return(0,p.jsxs)(`main`,{className:`site-shell base-modifiers-theme locations-theme`+(n?` sidebar-hidden`:``),onClick:w,children:[(0,p.jsx)(a,{hidden:n,onClose:v}),(0,p.jsxs)(`aside`,{className:`sidebar`,onClick:y,children:[(0,p.jsxs)(`div`,{className:`sidebar-head`,children:[(0,p.jsxs)(`div`,{className:`sidebar-brand`,children:[(0,p.jsx)(`span`,{className:`brand-mark`,children:(0,p.jsx)(l,{size:17})}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`b`,{children:`地点与兴趣点`}),(0,p.jsx)(`small`,{children:`其他信息`})]})]}),(0,p.jsx)(`button`,{className:`sidebar-toggle`,type:`button`,"aria-expanded":!n,"aria-label":n?`展开侧边栏`:`收起侧边栏`,onClick:()=>_(e=>!e),children:n?(0,p.jsx)(t,{size:17}):(0,p.jsx)(i,{size:17})})]}),(0,p.jsx)(`button`,{className:`sidebar-index-link`,type:`button`,onClick:e,children:`← 返回索引页`}),(0,p.jsxs)(`div`,{className:`sidebar-bulk`,children:[(0,p.jsx)(`button`,{type:`button`,onClick:()=>x(new Set(h)),children:`全部展开`}),(0,p.jsx)(`button`,{type:`button`,onClick:()=>x(new Set),children:`全部收起`})]}),(0,p.jsx)(c,{groups:g,label:`地点与兴趣点导航`})]}),(0,p.jsxs)(`div`,{className:`content-shell`,children:[(0,p.jsxs)(`header`,{id:`top`,className:`modifier-library-header`,children:[(0,p.jsx)(`h1`,{children:`地点与兴趣点`}),(0,p.jsx)(`p`,{children:`先列游戏本体，再按 Mod 分栏；包括神祇限定地点与兴趣点。地点列出可能配置的兴趣点，兴趣点反向列出可出现的地点，并链接其挑战与任务。`}),(0,p.jsx)(`p`,{children:`采用带 DLC 的本体和 Mod 当前有效版本。固定生成、随机候选、条件性追加与改建保留分别说明；没有找到正常生成路径的类型单独列出，不作为常规可遇内容。`})]}),(0,p.jsxs)(`section`,{className:`section`,id:`place-guide`,children:[(0,p.jsx)(`h2`,{children:`阅读说明`}),(0,p.jsx)(o,{config:m,items:d,openEntries:b,onToggle:C})]}),f.map(e=>(0,p.jsxs)(`div`,{className:`location-collection`,id:e.id,children:[(0,p.jsxs)(`div`,{className:`location-collection-heading`,children:[(0,p.jsx)(`p`,{className:`section-index`,children:[`places-base`,`places-cordyceps`].includes(e.id)?`游戏本体`:`Mod`}),(0,p.jsx)(`h2`,{children:e.title}),e.description&&(0,p.jsx)(`p`,{children:e.description})]}),e.sections.map(e=>(0,p.jsxs)(`section`,{className:`section location-section`,id:e.id,children:[(0,p.jsxs)(`h3`,{children:[e.title,(0,p.jsx)(`small`,{children:e.items.length})]}),(0,p.jsx)(o,{config:m,items:e.items,openEntries:b,onToggle:C})]},e.id))]},e.id)),(0,p.jsxs)(`footer`,{className:`archive-footer`,children:[(0,p.jsx)(`p`,{children:`地点修正仍归入地点修正资料；不会仅因名称类似建筑就把它们当成兴趣点。独立教程场景的专用原型不混入常规地图目录。`}),(0,p.jsx)(`p`,{children:`KeeperItemMod、Redeemer Agent、Event Pack REDUX、Alai 与 The Surveyor 已检查，未找到新增地点或兴趣点类型。其物品、人物、事件或地点修正仍保留在各自资料页。`}),(0,p.jsx)(`button`,{className:`sidebar-index-link`,type:`button`,onClick:e,children:`← 返回索引页`})]})]})]})}export{_ as default};