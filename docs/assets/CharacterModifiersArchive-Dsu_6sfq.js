...
3 级：Possession。
各法术仍需满足自身的 Personal Item、目标与执行地点要求。`,acquisition:`Study Blood 从无到 1、2、3 级分别消耗 1、2、3 <CrossReference name="Arcane Knowledge" href="#entry-character-base-t-arcaneknowledge" meta="角色修正" text="作为研习魔法的知识储备；消耗指定数量可提升 Mastery of Blood Magic、Mastery of Death 或 Mastery of Geomancy。持有后获得相应 Study 仪式。
持续与移除：知识保留到被 Study 消耗。" />；Warlock 可选择此学派起步。`,duration:`持续保留；没有固定回合倒计时。`,levels:`1–3`},{id:`character-base-t-masterydeath`,source:`base`,sourceName:`游戏本体`,name:`Mastery of Death`,category:`mobile`,eligible:`玩家 Agent；Vampire 等具有 Death Magic 的人物`,text:`1 级：Death’s Shadow、Skeletal Servitor、Macabre <CrossReference name="Fortress" href="?page=points-of-interest#entry-location-sub-fort" meta="兴趣点" text="为所在地点增加 200 防御上限，延长敌军攻占或摧毁地点所需时间。
...
3 级：Ravenous Dead。
同时拥有 1 级 Geomancy 可使用 Cthonian 相关法术；施法仍需满足各自的 Death、地点等条件。`,acquisition:`Study Death 从无到 1、2、3 级分别消耗 2、3、5 <CrossReference name="Arcane Knowledge" href="#entry-character-base-t-arcaneknowledge" meta="角色修正" text="作为研习魔法的知识储备；消耗指定数量可提升 Mastery of Blood Magic、Mastery of Death 或 Mastery of Geomancy。持有后获得相应 Study 仪式。
...
单位完成 Feed 时强度归零，恢复全部 HP，个人与当地 Shadow 各 +50 个百分点，Menace +8；消耗当地人口。Vampire 的进食还可能将饥饿传给合格的当地英雄或统治者。
统治者的 Feed 消耗 1 回合，强度归零，个人与当地 Shadow 各 +50 个百分点，Unrest +50。`,acquisition:`The Hunger 血魔法、Vampire 与 Feed 的传播及通用事件。`,duration:`<CrossReference name="Chosen One" href="#entry-character-base-t-chosenone" meta="角色修正" text="Command +2 +2×等级，Attack +1，Defence +2；不因衰老死亡。每回合清零 Shadow 与 Menace，第 10 回合后将 Awareness 设为 100%。清除 Call of the Abyss、Vampiric Curse 与 The Hunger。
持续与移除：持续保留；没有固定回合倒计时。" /> 会清除此状态。进食将强度清零，特质保留并继续积累饥饿。`},{id:`character-base-t-commandofvermin`,source:`base`,sourceName:`游戏本体`,name:`Command of Vermin`,category:`npc`,eligible:`Vampire；同一能力也被 Baroness 使用`,text:`每逢世界回合数为 5 的倍数时，若有空随从槽，补充一只 <CrossReference name="Vermin" href="?page=minions#entry-vermin" meta="随从" text="无特殊能力。" />（1 HP、1 Attack）。一次仅填一个槽位。`,acquisition:`Vampire 自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-base-t-mourning`,source:`base`,sourceName:`游戏本体`,name:`Mourning`,category:`common`,eligible:`失去亲友的英雄与统治者`,text:`记录正在哀悼的死者及杀害者，并使对应 Mourning 事件能够触发；本身不直接改变四项属性。`,acquisition:`亲属或喜欢的人死亡后，由人物关系系统加入。`,duration:`16 回合；每回合 −1，到期移除。`},{id:`character-base-t-chosenone`,source:`base`,sourceName:`游戏本体`,name:`Chosen One`,category:`hero`,eligible:`被选中的英雄`,text:`Command +2 +2×等级，Attack +1，Defence +2；不因衰老死亡。每回合清零 Shadow 与 Menace，第 10 回合后将 Awareness 设为 100%。清除 <CrossReference name="Call of the Abyss" href="#entry-character-base-t-calloftheabyss" meta="角色修正" text="强度每逢偶数回合 +1。自主人物可用 Maintain Humanity 将强度清零，但增加 3 Exhaustion；强度大于 0 时可执行 Descend into the Sea，转化为自主 Deep One。玩家 Agent 接受转化后不再受玩家控制，并释放一个 Agent 名额。
...
自主人物还可能因疯狂做出贿赂守卫、藏匿金币、增加当地 Unrest 或打断其他英雄等异常举动。玩家控制的 Agent 和 <CrossReference name="Deep One" href="?page=non-player-units#entry-npc-deep-one" meta="非玩家单位" text="先向海洋移动，随后能够两栖移动；寻找沿海人类聚居地建立 Cult，并在既有 Cult 暴露时降低其 Profile 或 Menace。初始个人 Shadow 为 100%。" /> 不执行这部分自主疯狂行为。`,acquisition:`Sanity 降到 0 时，由人物的疯狂判定产生。`,duration:`已取得的结果持续保留；恢复 Sanity 不会自动删除已有疯狂。`},{id:`character-base-mt-clayface`,source:`base`,sourceName:`游戏本体`,name:`Changeling`,category:`minion`,eligible:`Changeling`,text:`完成 Menace 大于 5 的挑战时，将该次完成 Menace 转给一个非 <CrossReference name="Chosen One" href="#entry-character-base-t-chosenone" meta="角色修正" text="Command +2 +2×等级，Attack +1，Defence +2；不因衰老死亡。每回合清零 Shadow 与 Menace，第 10 回合后将 Awareness 设为 100%。清除 Call of the Abyss、Vampiric Curse 与 The Hunger。
...
持续与移除：Chosen One 会自动清除此状态；其他人物通过专门行动抵抗或完成转化。" />、Howl: Death’s Curse、Insane、<CrossReference name="The Hunger" href="#entry-character-base-t-thehunger" meta="角色修正" text="饥饿强度每回合 +3，推动人物执行 Feed。
单位完成 Feed 时强度归零，恢复全部 HP，个人与当地 Shadow 各 +50 个百分点，Menace +8；消耗当地人口。Vampire 的进食还可能将饥饿传给合格的当地英雄或统治者。
统治者的 Feed 消耗 1 回合，强度归零，个人与当地 Shadow 各 +50 个百分点，Unrest +50。
...
持续与移除：持续保留；没有固定回合倒计时。" />`,text:`饥饿每回合 +0.3，越高越倾向消耗 Madness。
...
Recollect 消耗 Madness，每消耗 1 点使饥饿 −2，最低 0。`,acquisition:`<CrossReference name="Inundai Emissary" href="#entry-character-2879667447-t-inundai" meta="角色修正" text="每回合将正数 Profile 与 Menace 清到 0，不因衰老死亡。全部 Inundai Presence 被封锁或摧毁后，失去在世界中存在的联系。
