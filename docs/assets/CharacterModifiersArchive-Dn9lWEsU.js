...
持续与移除：知识保留到被 Study 消耗。" />；Warlock 可选择此学派起步。`,duration:`持续保留；没有固定回合倒计时。`,levels:`1–3`},{id:`character-base-t-masterydeath`,source:`base`,sourceName:`游戏本体`,name:`Mastery of Death`,category:`mobile`,eligible:`玩家 Agent；Vampire 等具有 <CrossReference name="Death" href="?god=aberrant-metal#entry-death" meta="地点修正" text="地点积累的死亡力量，可供 Death 魔法与亡灵相关行动使用，地点成为废墟后仍保留。
...
正常游戏中达到 300 时触发 Death Crisis，并在当地生成两个自主 Ghast；同一份修正只触发一次。" /> 从无到 1、2、3 级分别消耗 2、3、5 <CrossReference name="Arcane Knowledge" href="#entry-character-base-t-arcaneknowledge" meta="角色修正" text="作为研习魔法的知识储备；消耗指定数量可提升 Mastery of Blood Magic、Mastery of Death 或 Mastery of Geomancy。持有后获得相应 Study 仪式。
持续与移除：知识保留到被 Study 消耗。" />；相关施法者也可能起始拥有。`,duration:`持续保留；没有固定回合倒计时。`,levels:`1–3`},{id:`character-base-t-masterygeomancy`,source:`base`,sourceName:`游戏本体`,name:`Mastery of Geomancy`,category:`mobile`,eligible:`玩家 Agent 与 Mage 等施法英雄`,text:`1 级：Nurture、Tremor、<CrossReference name="Arcane Fortress" href="?god=escamrak#entry-arcane-fortress" meta="地点修正" text="保护地点免受魔法攻击，吸收敌对法师造成的部分伤害；地点沦为废墟后仍保留。" />、Attack Channeller。
...
持续与移除：知识保留到被 Study 消耗。" />；施法职业可起始拥有。`,duration:`持续保留；没有固定回合倒计时。`,levels:`1–3`},{id:`character-base-t-challengebooster`,source:`base`,sourceName:`游戏本体`,name:`Specialist`,category:`hero`,eligible:`英雄；Doctor 起始拥有 Physician，转为玩家控制后仍可保留`,text:`与专长标签匹配的任务进度每回合 +3。战斗开始时，若敌方具有对应标签，Defence +4。
Physician：Disease。
Mediator：Discord。
Exorcist：Undead。
Lightbringer：Shadow。
...
持续与移除：持续保留；没有固定回合倒计时。" />、英雄、Outpost 的意愿 −40；Sociopath 将 Cruelty 偏好设为 +2，Cooperation 设为 −1。
...
持续与移除：持续保留；没有固定回合倒计时。" /> 除外`,text:`感染成熟度每回合 +2，上限 100。感染者位于非精灵的人类聚居地时，<CrossReference name="Infected Populace" href="?god=cordyceps#entry-infected-populace" meta="地点修正" text="表示人口的感染百分比，最高 100%。感染人口是 Drone 收割的对象，并提供 Infect Populace 和 Treat Populace；达到相应感染程度还可使用 Disrupted Neurology、Targeted Infection 与 Internal Maturation。强度降至 0 仍保留，聚居地沦为废墟时移除。" /> 每回合 +2。
每回合分别对同地合格人类角色尝试传染，概率为成熟度/100 × 2.5%；目标须 Awareness <100%，且不是 <CrossReference name="Chosen One" href="#entry-character-base-t-chosenone" meta="角色修正" text="Command +2 +2×等级，Attack +1，Defence +2；不因衰老死亡。每回合清零 Shadow 与 Menace，第 10 回合后将 Awareness 设为 100%。清除 Call of the Abyss、Vampiric Curse 与 The Hunger。
持续与移除：持续保留；没有固定回合倒计时。" /> 或敌对自主怪物。统治者 <CrossReference name="Raise Army" href="?page=locations#entry-place-ruler-base-act-raisearmy" meta="统治者行动" text="创建一支 Human Army，成为当地驻军。" /> 的执行倾向减少当前成熟度。
...
持续与移除：持续保留；没有固定回合倒计时。" /> 会自动移除此状态。转化与清除感染的对应行动按各自规则处理。`},{id:`character-base-temporary-divineentity`,source:`base`,sourceName:`游戏本体`,name:`Divine Blessing`,category:`player`,eligible:`被 Divine Entity 奖励选中的玩家 Agent`,text:`Intrigue、Lore、Command 各 +1。`,acquisition:`满足 Divine Entity 的愿望后，随机奖励选择 Blessing；从尚未持有临时 Command 特质的玩家 Agent 中选取一人。`,duration:`27 回合。`},{id:`character-base-event-injury`,source:`base`,sourceName:`游戏本体`,name:`Injury`,category:`mobile`,eligible:`对应事件及选项指定的角色`,text:`<CrossReference name="The young of the serpent" href="?page=events#entry-event-base-fog-exploreruins-infil3" meta="事件" text="完成 Explore Ruins 后，在符合条件的遗迹探索事件中抽取。
...
现有英雄或宗教人物保留原单位并获得控制权。对统治者施放时，移除其统治者职位，以原人物生成一名自主 Warrior；其 Might、Command 额外各 +1，HP 为 6。" /> 按消耗的强度增加 Lore，并给予 <CrossReference name="Blessing of the Eye" href="#entry-character-base-t-et-eye" meta="角色修正" text="每回合 Menace −0.05×祝福等级。
持续与移除：持续保留；没有固定回合倒计时。" />。`,acquisition:`对家族成员施放同名 Maker’s Curse 神力。`,duration:`<CrossReference name="Create Agent" href="?god=broken-maker#entry-create-agent" meta="神力" text="消耗 1 次招募额度，并移除目标 House 的全部 Maker's Curse。按 Sword／Eye／Midnight／Traitor 强度分别增加 Might／Lore／Intrigue／Command，Intrigue 最多增加 5；获得相应 Blessing。
...
现有英雄或宗教人物保留原单位并获得控制权。对统治者施放时，移除其统治者职位，以原人物生成一名自主 Warrior；其 Might、Command 额外各 +1，HP 为 6。" /> 增加 min(5，强度) Intrigue，并给予 <CrossReference name="Blessing of Midnight" href="#entry-character-base-t-et-midnight" meta="角色修正" text="每回合 Profile −0.05×祝福等级。
持续与移除：持续保留；没有固定回合倒计时。" />。`,acquisition:`对家族成员施放同名 Maker’s Curse 神力。`,duration:`<CrossReference name="Create Agent" href="?god=broken-maker#entry-create-agent" meta="神力" text="消耗 1 次招募额度，并移除目标 House 的全部 Maker's Curse。按 Sword／Eye／Midnight／Traitor 强度分别增加 Might／Lore／Intrigue／Command，Intrigue 最多增加 5；获得相应 Blessing。
现有英雄或宗教人物保留原单位并获得控制权。对统治者施放时，移除其统治者职位，以原人物生成一名自主 Warrior；其 Might、Command 额外各 +1，HP 为 6。" /> 移除家族的 Maker’s Curse；<CrossReference name="Create Agent Masterfully" href="?god=broken-maker#entry-create-agent-masterfully" meta="神力" text="消耗 1 次招募额度。目标 House 的每项 Maker's Curse 先减半并向下取整，按减半后的强度给予属性和 Blessing，诅咒以剩余强度继续保留。
...
现有英雄或宗教人物保留原单位并获得控制权。对统治者施放时，移除其统治者职位，以原人物生成一名自主 Warrior；其 Might、Command 额外各 +1，HP 为 6。" /> 按强度增加 Might；强度大于 0 时给予 <CrossReference name="Blessing of the Sword" href="#entry-character-base-t-et-sword" meta="角色修正" text="杀死英雄时，若当地属于人类国家，Menace +20，并使该国家在满足条件时爆发内战。
持续与移除：持续保留；没有固定回合倒计时。" />。`,acquisition:`对家族成员施放同名 Maker’s Curse 神力。`,duration:`<CrossReference name="Create Agent" href="?god=broken-maker#entry-create-agent" meta="神力" text="消耗 1 次招募额度，并移除目标 House 的全部 Maker's Curse。按 Sword／Eye／Midnight／Traitor 强度分别增加 Might／Lore／Intrigue／Command，Intrigue 最多增加 5；获得相应 Blessing。
现有英雄或宗教人物保留原单位并获得控制权。对统治者施放时，移除其统治者职位，以原人物生成一名自主 Warrior；其 Might、Command 额外各 +1，HP 为 6。" /> 移除家族的 Maker’s Curse；<CrossReference name="Create Agent Masterfully" href="?god=broken-maker#entry-create-agent-masterfully" meta="神力" text="消耗 1 次招募额度。目标 House 的每项 Maker's Curse 先减半并向下取整，按减半后的强度给予属性和 Blessing，诅咒以剩余强度继续保留。
...
现有英雄或宗教人物保留原单位并获得控制权。对统治者施放时，移除其统治者职位，以原人物生成一名自主 Warrior；其 Might、Command 额外各 +1，HP 为 6。" /> 按现有诅咒强度增加 Command；强度大于 0 时给予 <CrossReference name="Blessing of the Traitor" href="#entry-character-base-t-et-traitor" meta="角色修正" text="执行受 Security 影响的行动时，Security −3。
持续与移除：持续保留；没有固定回合倒计时。" />。游戏提示以家族成员转为 Agent 累积强度，但当前版本未实现这一步增长。`,acquisition:`对家族成员施放同名 Maker’s Curse 神力。`,duration:`<CrossReference name="Create Agent" href="?god=broken-maker#entry-create-agent" meta="神力" text="消耗 1 次招募额度，并移除目标 House 的全部 Maker's Curse。按 Sword／Eye／Midnight／Traitor 强度分别增加 Might／Lore／Intrigue／Command，Intrigue 最多增加 5；获得相应 Blessing。
现有英雄或宗教人物保留原单位并获得控制权。对统治者施放时，移除其统治者职位，以原人物生成一名自主 Warrior；其 Might、Command 额外各 +1，HP 为 6。" /> 移除家族的 Maker’s Curse；<CrossReference name="Create Agent Masterfully" href="?god=broken-maker#entry-create-agent-masterfully" meta="神力" text="消耗 1 次招募额度。目标 House 的每项 Maker's Curse 先减半并向下取整，按减半后的强度给予属性和 Blessing，诅咒以剩余强度继续保留。
...
单位完成 Feed 时强度归零，恢复全部 HP，个人与当地 Shadow 各 +50 个百分点，Menace +8；消耗当地人口。Vampire 的进食还可能将饥饿传给合格的当地英雄或统治者。
统治者的 Feed 消耗 1 回合，强度归零，个人与当地 Shadow 各 +50 个百分点，Unrest +50。
持续与移除：Chosen One 会清除此状态。进食将强度清零，特质保留并继续积累饥饿。" />。死亡留下强度 20 的 <CrossReference name="Immortal Body" href="?god=ixthus#entry-immortal-body" meta="地点修正" text="显示死者姓名；复苏达到 100 后在此恢复生命并移除身体，恢复满 HP，Profile 减半。可控制人物仍需要空余 Agent 位。绑定后停止复苏。" />。`,acquisition:`拥有永生的人物转化为 Vampiric <CrossReference name="Knight" href="?page=minions#entry-knight" meta="随从" text="无特殊能力。" /> 时获得。`,duration:`持续保留；遗体未被绑定时可复生。`},{id:`character-2866026291-t-immortalknightdeath`,source:`2866026291`,sourceName:`Ixthus, King of cups`,name:`Embraced Immortality`,category:`npc`,eligible:`<CrossReference name="Dread Knight" href="?god=ixthus#entry-dread-knight" meta="特殊人物与自主单位" text="不可控制的自主单位，会旅行、袭击人物，使用下列能力掠夺并强化自身。" />`,text:`在人类聚居地（Crypt 除外）每回合 <CrossReference name="Devastation" href="?god=aberrant-metal#entry-devastation" meta="地点修正" text="战争、战斗或其他暴力造成的地点破坏。每 1 点强度使 Prosperity 减少 0.005；食物产出乘数为 1 − 强度/200，最低为 0.1。
达到 300 时，尚未成为 City Ruins 的聚居地会被摧毁。" /> +3，受伤时恢复 1 HP。死亡留下强度 20 的 <CrossReference name="Immortal Body" href="?god=ixthus#entry-immortal-body" meta="地点修正" text="显示死者姓名；复苏达到 100 后在此恢复生命并移除身体，恢复满 HP，Profile 减半。可控制人物仍需要空余 Agent 位。绑定后停止复苏。" />。`,acquisition:`拥有永生的人物接受永生并转化为 <CrossReference name="Dread Knight" href="?god=ixthus#entry-dread-knight" meta="特殊人物与自主单位" text="不可控制的自主单位，会旅行、袭击人物，使用下列能力掠夺并强化自身。" />。`,duration:`持续保留；遗体未被绑定时可复生。`},{id:`character-2879207914-t-bloodstain`,source:`2879207914`,sourceName:`Kishi, God of Bloodshed`,name:`Bloodstained`,category:`common`,eligible:`杀死人物或被神力赋予血痕的人物`,text:`用于支付 Kishi 神力。杀死人物获得 1 层；死者 Bloodstained >1 时还继承其血痕，已有 <CrossReference name="Soul-Scarred" href="#entry-character-2879207914-t-bloodshed-soulscar" meta="角色修正" text="记录已消耗的 Bloodstain；仍计入历史杀戮总量，可被要求历史杀戮的神力识别。
持续与移除：持续保留；没有固定回合倒计时。" /> 也会被继承。持有者移动时同步更新地点的 <CrossReference name="Bloodstain" href="?god=kishi#entry-bloodstain" meta="相关机制" text="尚未被消费的杀戮层数。可由杀人、主动宣战和 Soldier Worship 获得；消费时转化为同量 Soul-Scar。" /> Present。`,acquisition:`人物杀戮与 Kishi 的相关神力。`,duration:`被神力消耗的血痕转为 <CrossReference name="Soul-Scarred" href="#entry-character-2879207914-t-bloodshed-soulscar" meta="角色修正" text="记录已消耗的 Bloodstain；仍计入历史杀戮总量，可被要求历史杀戮的神力识别。
持续与移除：持续保留；没有固定回合倒计时。" />；现存层数归零时移除 Bloodstained。`},{id:`character-2879207914-t-bloodshed-soulscar`,source:`2879207914`,sourceName:`Kishi, God of Bloodshed`,name:`Soul-Scarred`,category:`common`,eligible:`血痕已被消耗的人物`,text:`记录已消耗的 <CrossReference name="Bloodstain" href="?god=kishi#entry-bloodstain" meta="相关机制" text="尚未被消费的杀戮层数。可由杀人、主动宣战和 Soldier Worship 获得；消费时转化为同量 Soul-Scar。" />；仍计入历史杀戮总量，可被要求历史杀戮的神力识别。`,acquisition:`消耗 <CrossReference name="Bloodstained" href="#entry-character-2879207914-t-bloodstain" meta="角色修正" text="用于支付 Kishi 神力。杀死人物获得 1 层；死者 Bloodstained ＞1 时还继承其血痕，已有 Soul-Scarred 也会被继承。持有者移动时同步更新地点的 Bloodstain Present。
持续与移除：被神力消耗的血痕转为 Soul-Scarred；现存层数归零时移除 Bloodstained。" /> 时，按实际消耗数量转入；击杀具有此状态的人物也会继承。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-2879207914-t-bloodshed-latentvampirism`,source:`2879207914`,sourceName:`Kishi, God of Bloodshed`,name:`Latent Vampirism`,category:`common`,eligible:`Kishi 选中的人物`,text:`人物死亡后，下一回合在死亡地点复活为 Vampire。`,acquisition:`<CrossReference name="Unending Bloodshed" href="?god=kishi#entry-unending-bloodshed" meta="神力" text="消耗 2 层 Bloodstain，赋予 The Hunger 与 Latent Vampirism。目标死后会在下一回合以 Vampire 身份于死亡地点复活。" /> 神力。`,duration:`死亡触发；下一回合复活为 Vampire。`},{id:`character-2879207914-t-bloodshed-martyrforwar`,source:`2879207914`,sourceName:`Kishi, God of Bloodshed`,name:`Martyr for War`,category:`hero`,eligible:`采用相应教义的教士`,text:`人物死亡时，所在地增加 100 <CrossReference name="Unrest" href="?god=aberrant-metal#entry-unrest" meta="地点修正" text="居民对统治者的不满会发展为抗议、暴乱和起义。每 1 点强度使 Prosperity 减少 0.005。当地达到 100 时 Security −4；每个达到 100 的相邻地点再使 Security −1，其中存在 Infiltration 的相邻地点各额外 −1。
...
达到 300 时强度回落到 150；若当地是人类聚居地且尚无 Madness Effect，则触发 Madness Crisis，等概率留下六种长期效果之一。" />，每消耗 1 点使饥饿 −2，最低 0。`,acquisition:`<CrossReference name="Inundai Emissary" href="#entry-character-2879667447-t-inundai" meta="角色修正" text="每回合将正数 Profile 与 Menace 清到 0，不因衰老死亡。全部 Inundai Presence 被封锁或摧毁后，失去在世界中存在的联系。
持续与移除：持续保留；没有固定回合倒计时。" /> 自带，与单位的饥饿值同步。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-2879667447-t-inundai-agentpayment`,source:`2879667447`,sourceName:`Deep Ones Plus`,name:`Inundai Favor`,category:`player`,eligible:`接受 <CrossReference name="Inundai Patronage" href="#entry-character-2879667447-t-inundai-patronage" meta="角色修正" text="允许请求金币、粮食、压制 Unrest、恢复 Sanity 或报复等援助，每次请求积累 Inundai Debt。
...
在有 Inundai Presence 的地点消费 Favor 换取援助。`,acquisition:`Agent 接受 <CrossReference name="Inundai Patronage" href="#entry-character-2879667447-t-inundai-patronage" meta="角色修正" text="允许请求金币、粮食、压制 Unrest、恢复 Sanity 或报复等援助，每次请求积累 Inundai Debt。
...
同样在无需治疗时，非玩家控制人物每回合增加“0.5% × 等级”的个人 Shadow；每次获得突变还失去 10 Sanity。突变包括 Tooth Armor、Extra Arms、Cannibalistic Hunger、Bone Spines、Pus Growths、Terrifying Appearance、Gibbering Mouths、Second Head、Extra Organs、Living Tumors。
持续与移除：持续保留；没有固定回合倒计时。" /> 达到 12 点突变进度时，从适用且未拥有的突变中取得。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-2900259087-mt-minionfleshregen`,source:`2900259087`,sourceName:`Flesh God`,name:`Regeneration`,category:`minion`,eligible:`具有再生能力的 Fleshcrafting 随从`,text:`每回合恢复 HP，不超过上限。
...
非女巫诅咒造成的感染，在狼人形态还具有 <CrossReference name="Infectious Curse" href="#entry-character-2932110698-t-nature-werewolfinfectiousness" meta="角色修正" text="本人或随从在战斗中对符合条件的人物造成 HP 伤害，可传播 Lycanthropy。
...
持续与移除：持续保留；没有固定回合倒计时。" /> 与亡灵不能正常转化。`,duration:`感染长期保留；每轮变身 20 回合，特定选择可以永久保持狼人形态。`},{id:`character-2932110698-t-nature-werewolfinfectiousness`,source:`2932110698`,sourceName:`Living Wilds`,name:`Infectious Curse`,category:`mobile`,eligible:`狼人及处于狼人形态的感染人物`,text:`本人或随从在战斗中对符合条件的人物造成 HP 伤害，可传播 <CrossReference name="Lycanthropy" href="#entry-character-2932110698-t-nature-lycanthropy" meta="角色修正" text="每逢 Blood Moon（默认每 50 回合）进入狼人形态，默认持续 20 回合。通常会转为自主狩猎；自愿接受的英雄和教士保留正常活动倾向。
狼人形态获得 Feral Might，使基础属性与特质合计 Might 至少为 3；获得 Lupine Dominion，定期补充 Wolf。非自愿变形者还获得 Wilderness Creature，在人类聚居地每回合 Profile、Menace 各 +1，Lay Low 期间不增加。
非女巫诅咒造成的感染，在狼人形态还具有 Infectious Curse。变回时移除这些形态能力，保留 HP 和原人物。
持续与移除：感染长期保留；每轮变身 20 回合，特定选择可以永久保持狼人形态。" />。`,acquisition:`狼人自带；非女巫诅咒造成的 <CrossReference name="Lycanthropy" href="#entry-character-2932110698-t-nature-lycanthropy" meta="角色修正" text="每逢 Blood Moon（默认每 50 回合）进入狼人形态，默认持续 20 回合。通常会转为自主狩猎；自愿接受的英雄和教士保留正常活动倾向。
狼人形态获得 Feral Might，使基础属性与特质合计 Might 至少为 3；获得 Lupine Dominion，定期补充 Wolf。非自愿变形者还获得 Wilderness Creature，在人类聚居地每回合 Profile、Menace 各 +1，Lay Low 期间不增加。
非女巫诅咒造成的感染，在狼人形态还具有 Infectious Curse。变回时移除这些形态能力，保留 HP 和原人物。
...
启用 Curseweaving 时，已捕获的灵魂可用于 Transpose Soul(s) 炼成物品，也可施展 Rite of Masks 及多种诅咒；黑暗阵营和怪物灵魂不适用诅咒。两个不同职业的灵魂可以组合炼成更高级的物品。
与 Living Wilds 同时启用时，还支持相关 Werewolf 灵魂与诅咒。" /> 与 1 <CrossReference name="Arcane Knowledge" href="#entry-character-base-t-arcaneknowledge" meta="角色修正" text="作为研习魔法的知识储备；消耗指定数量可提升 Mastery of Blood Magic、Mastery of Death 或 Mastery of Geomancy。持有后获得相应 Study 仪式。
持续与移除：知识保留到被 Study 消耗。" />。`,acquisition:`Study Curseweaving；可选该学派的施法者起始选择。`,duration:`持续保留；没有固定回合倒计时。`,levels:`1–3`},{id:`character-2932765110-t-mirror`,source:`2932765110`,sourceName:`Covens, Curses & Curios Recast`,name:`Mirrored`,category:`common`,eligible:`被镜像诅咒选中的英雄与统治者`,text:`每回合把全部普通与极端喜恶复制为目标人物的喜恶。`,acquisition:`Mirrored 家族诅咒。`,duration:`失去有效目标、成为 <CrossReference name="Chosen One" href="#entry-character-base-t-chosenone" meta="角色修正" text="Command +2 +2×等级，Attack +1，Defence +2；不因衰老死亡。每回合清零 Shadow 与 Menace，第 10 回合后将 Awareness 设为 100%。清除 Call of the Abyss、Vampiric Curse 与 The Hunger。
持续与移除：持续保留；没有固定回合倒计时。" /> 或受玩家控制时移除。`},{id:`character-2932765110-t-murderofcrows`,source:`2932765110`,sourceName:`Covens, Curses & Curios Recast`,name:`Murder of Crows`,category:`hero`,eligible:`采用 Aviaries 的教士`,text:`每逢第 5 回合，有空槽且至少剩余 1 Command 时，补充一只 Crow（1 HP、2 Attack、1 Command）。`,acquisition:`Aviaries 教义。`,duration:`随该教义的授予条件生效。`},{id:`character-2932765110-t-phthisicalpoisoned`,source:`2932765110`,sourceName:`Covens, Curses & Curios Recast`,name:`Disfigured by Phthisical Poison`,category:`hero`,eligible:`被 <CrossReference name="Esoteric Poisons" href="#entry-character-2932765110-t-poisoner" meta="角色修正" text="把 Poison Hero 的普通毒替换为 Phthisical Poison：打断时间翻倍为 10 回合，并造成永久四属性减益。
...
首次直接取得正等级时，获得一枚 Soulstone 与 1 Arcane Knowledge。
持续与移除：持续保留；没有固定回合倒计时。" /> 后，在升级时选择。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-2932765110-t-wanderer`,source:`2932765110`,sourceName:`Covens, Curses & Curios Recast`,name:`Insatiable Wanderlust`,category:`hero`,eligible:`受诅咒的自主英雄与教士`,text:`每完成一种任务，该类任务的执行意愿 −50，可累加；每回合恢复 1。另记录攻击、守卫、干扰等重复行为，抑制重复行动。`,acquisition:`Insatiable Wanderlust 家族诅咒；女巫惩罚侵入教士。`,duration:`成为 <CrossReference name="Chosen One" href="#entry-character-base-t-chosenone" meta="角色修正" text="Command +2 +2×等级，Attack +1，Defence +2；不因衰老死亡。每回合清零 Shadow 与 Menace，第 10 回合后将 Awareness 设为 100%。清除 Call of the Abyss、Vampiric Curse 与 The Hunger。
持续与移除：持续保留；没有固定回合倒计时。" /> 或玩家控制人物后移除。`},{id:`character-2932765110-temporary-sharedwisdom`,source:`2932765110`,sourceName:`Covens, Curses & Curios Recast`,name:`Shared Wisdom · Lore`,category:`mobile`,eligible:`停留在对应教团 Temple 的角色`,text:`Lore 加成为教义等级的相反数：−1/−2/−3 级分别 +1/+2/+3；+1/+2/+3 级分别 −1/−2/−3。`,acquisition:`Shared Wisdom 教义非 0 级，人物停留在该教团的 Temple。`,duration:`每次增减持续 1 回合；仍满足条件时每回合再次赋予。`},{id:`character-2932765110-curse-lycanthropy`,source:`2932765110`,sourceName:`Covens, Curses & Curios Recast`,name:`Curse of Lycanthropy`,category:`common`,eligible:`受诅咒家族的角色与统治者；<CrossReference name="Chosen One" href="#entry-character-base-t-chosenone" meta="角色修正" text="Command +2 +2×等级，Attack +1，Defence +2；不因衰老死亡。每回合清零 Shadow 与 Menace，第 10 回合后将 Awareness 设为 100%。清除 Call of the Abyss、Vampiric Curse 与 The Hunger。
持续与移除：持续保留；没有固定回合倒计时。" /> 除外`,text:`在同时启用 Living Wilds 时，为合格家族成员施加 <CrossReference name="Lycanthropy" href="#entry-character-2932110698-t-nature-lycanthropy" meta="角色修正" text="每逢 Blood Moon（默认每 50 回合）进入狼人形态，默认持续 20 回合。通常会转为自主狩猎；自愿接受的英雄和教士保留正常活动倾向。
狼人形态获得 Feral Might，使基础属性与特质合计 Might 至少为 3；获得 Lupine Dominion，定期补充 Wolf。非自愿变形者还获得 Wilderness Creature，在人类聚居地每回合 Profile、Menace 各 +1，Lay Low 期间不增加。
非女巫诅咒造成的感染，在狼人形态还具有 Infectious Curse。变回时移除这些形态能力，保留 HP 和原人物。
持续与移除：感染长期保留；每轮变身 20 回合，特定选择可以永久保持狼人形态。" />。默认每 50 回合进入 Blood Moon，狼人形态持续 20 回合；女巫诅咒造成的狼人不获得传染他人的 <CrossReference name="Infectious Curse" href="#entry-character-2932110698-t-nature-werewolfinfectiousness" meta="角色修正" text="本人或随从在战斗中对符合条件的人物造成 HP 伤害，可传播 Lycanthropy。
持续与移除：成功传播后冷却 60 回合；普通感染者变回人形后移除。" />。`,acquisition:`<CrossReference name="Mastery of Curseweaving" href="#entry-character-2932765110-t-masterycurseweaving" meta="角色修正" text="以 Soulstone 中的灵魂施展家族诅咒与灵魂编织。加入 Magic Plague、Soul Trap 和 Study Curseweaving；抵达有 Fallen Human 的地点时增加对应 Capture Soul。
首次直接取得正等级时，获得一枚 Soulstone 与 1 Arcane Knowledge。
持续与移除：持续保留；没有固定回合倒计时。" /> 至少 2 级，持有装有 <CrossReference name="Werewolf" href="?page=non-player-units#entry-npc-werewolf-hermit" meta="非玩家单位" text="初始 Shadow 取出生地点值，低于 50% 为明亮形态，达到 50% 为黑暗形态。在荒野时每回合向地点 Shadow 靠拢，最多变化 5 个百分点；达到 100% 后停止这种自然变化。没有灵魂，属于 Critter。
...
持续与移除：持续保留；没有固定回合倒计时。" /> 会在特质结算时摆脱感染。
...
可出现地点
City、小型人类聚居地、Elven City、Dwarven City、Dwarven Outpost、Orc Camp、Abyssal City、Aberrant Factory、Mobile Factory（驻地）。
改建或覆灭后是否保留，还受对应流程限制。" /> 的 Efficiency。`,acquisition:`对应 <CrossReference name="Aberrant Construct" href="#entry-character-3320562229-t-factory-construct" meta="角色修正" text="标记由 Production Core 维持的构造体，HP 上限随其出生地 Core Efficiency 变化。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3320562229-t-factory-recycler`,source:`3320562229`,sourceName:`Aberrant Metal`,name:`Recycling Unit`,category:`npc`,eligible:`<CrossReference name="Aberrant Recycler" href="?god=aberrant-metal#entry-aberrant-recycler" meta="特殊人物与自主单位" text="由 Biometallic Mass 组装的自主单位。具有 Aberrant Construct 与 Recycling Unit；所属核心消失时死亡。HP 上限每回合更新，上限提高不自动恢复 HP。
...
普通传播门槛为 25，Smog-Bound 路线上为 10。沿路线的烟雾只向更靠近终点的路径地点输送。" />。`,acquisition:`对应 <CrossReference name="Aberrant Construct" href="#entry-character-3320562229-t-factory-construct" meta="角色修正" text="标记由 Production Core 维持的构造体，HP 上限随其出生地 Core Efficiency 变化。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3320562229-t-factory-repo`,source:`3320562229`,sourceName:`Aberrant Metal`,name:`Reposession Unit`,category:`npc`,eligible:`<CrossReference name="Aberrant Repomen" href="?god=aberrant-metal#entry-aberrant-repomen" meta="特殊人物与自主单位" text="由 Churning Machinery 组装的自主单位。具有 Aberrant Construct 与 Reposession Unit；所属核心消失时死亡。HP 上限每回合更新，上限提高不自动恢复 HP。
...
持续与移除：持续保留；没有固定回合倒计时。" /> 除外；持有的每名 <CrossReference name="Devoured Puppet" href="?god=alai#entry-devoured-puppet" meta="随从" text="名称为 Puppet 加人物名，肖像沿用原人物。通过 Ensnare 收服时，保留目标当前 HP；战斗后选择复活为 Puppet 时恢复满血，Loyal Attendant 也以满血加入。
...
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的人物`,text:`获得时，对自身家族的偏好提高一级。通过 the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的家族诅咒获得时，提高的是对 the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的偏好。`,acquisition:`选择 Brood Mentality 后，由家族诅咒赋予。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3383875039-t-web-predatoryinstinct`,source:`3383875039`,sourceName:`Alai, God of Webs`,name:`Predatory Instinct`,category:`common`,eligible:`the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的人物`,text:`攻击其他家族人物的意愿 +30，保护他们的意愿 −30。挑战、统治者行动和国家行动若有利于其他家族，执行意愿 −30；否则，若不利于其他家族，执行意愿 +30。每次行动至多应用一次这项修正。`,acquisition:`选择 Predatory Instinct 后，由家族诅咒赋予。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3383875039-t-web-psychicempathy`,source:`3383875039`,sourceName:`Alai, God of Webs`,name:`Psychic Empathy`,category:`ruler`,eligible:`the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的统治者`,text:`作为统治者时，每回合使领地已有 <CrossReference name="Unrest" href="?god=alai#entry-unrest" meta="地点修正" text="居民对统治者的不满会发展为抗议、暴乱和起义。每 1 点强度使 Prosperity 减少 0.005。当地达到 100 时 Security −4；每个达到 100 的相邻地点再使 Security −1，其中存在 Infiltration 的相邻地点各额外 −1。
...
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" />，已有 <CrossReference name="Political Agitation" href="?god=alai#entry-political-agitation" meta="地点修正" text="地方统治者反对君主的政治活动，推动首都 Political Instability 并增加内战风险。" /> 也减少 2 点。`,acquisition:`选择 Psychic Empathy 后，由家族诅咒赋予。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3383875039-t-web-calltoslumber`,source:`3383875039`,sourceName:`Alai, God of Webs`,name:`Call to Slumber`,category:`hero`,eligible:`the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的自主英雄与教士`,text:`Rest & Resupply 中，由连续完成挑战数产生的休息意愿提高至 3 倍，故乡原有的双倍加成照常生效。拥有该能力的人物休息时，每回合 Power +0.02，最高恢复至神力上限。`,acquisition:`选择 Call to Slumber 后，由家族诅咒赋予。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3383875039-t-web-rebirthvenom`,source:`3383875039`,sourceName:`Alai, God of Webs`,name:`Rebirth Venom`,category:`hero`,eligible:`the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的自主英雄与教士`,text:`选择 Rebirth Venom 后，自主行动的 <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 在战斗中杀死另一名自主行动、尚未加入 the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的英雄或教士时，可通过对应事件使其满血复活并加入 the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" />。复活后，双方对彼此的偏好各提高一级。`,acquisition:`选择 Rebirth Venom 后，由家族诅咒赋予。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3383875039-t-web-parallelthoughts`,source:`3383875039`,sourceName:`Alai, God of Webs`,name:`Parallel Thoughts`,category:`common`,eligible:`the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的人物`,text:`同地有另一名 <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物，或当地另有一名 <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 统治者时，Might、Lore、Intrigue、Command 各 +1。加成以地图上的人物和当地统治者为判定对象，多名同伴提供的加成相同。`,acquisition:`选择 Parallel Thoughts 后，由家族诅咒赋予。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3383875039-t-web-restitchingsinews`,source:`3383875039`,sourceName:`Alai, God of Webs`,name:`Restitching Sinews`,category:`mobile`,eligible:`the <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的人物单位`,text:`人物单位每回合恢复 1 HP，最高至自身上限。选择 Restitching Sinews 后，<CrossReference name="Devoured Puppet" href="?god=alai#entry-devoured-puppet" meta="随从" text="名称为 Puppet 加人物名，肖像沿用原人物。通过 Ensnare 收服时，保留目标当前 HP；战斗后选择复活为 Puppet 时恢复满血，Loyal Attendant 也以满血加入。
...
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 的人物`,text:`每回合使所在地已有 <CrossReference name="Unrest" href="?god=alai#entry-unrest" meta="地点修正" text="居民对统治者的不满会发展为抗议、暴乱和起义。每 1 点强度使 Prosperity 减少 0.005。当地达到 100 时 Security −4；每个达到 100 的相邻地点再使 Security −1，其中存在 Infiltration 的相邻地点各额外 −1。
达到 300 时触发 Unrest Crisis，现任统治者会被民众处决，强度回落到 150，并清除当地 Lingering Resentment。
...
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物的意愿 +100；同时属于 Alliance 且符合条件时，还可增加 20。被其在战斗中击败的 <CrossReference name="Devoured" href="#entry-character-3383875039-t-web-devoured" meta="角色修正" text="成为 the Devoured 后，可受 Alai 的相关神力操纵；解除时优先恢复先前家族。担任统治者时，领地获得 Devoured Court，Security −2。
受控人物可在同地对自主行动的 Devoured 英雄或教士使用 Ensnare，Chosen One 除外；持有的每名 Devoured Puppet 都可通过 Release 释放。人物移动和每回合结算时，相关仪式随当前位置与随从更新。解散随从或主人死亡时，仍存活的 Puppet 会返回主人最后所在地点。
持续与移除：持续保留；没有固定回合倒计时。" /> 英雄、教士或 Agent，可通过对应事件满血复活、清空个人 Shadow、解除控制并恢复先前家族；<CrossReference name="Embraced" href="?god=alai#entry-embraced" meta="特殊人物与自主单位" text="由 Awaken Crusader、Awaken Emissary、Awaken Enchanter 或 Awaken Weaver 转化 Devoured 英雄、教士，或已有人物单位的统治者。所选形态决定所有 Embraced 的称号和行动：Crusader 制造 Ravagers；Emissary 将领地纳入或创立 Dark Empire；Enchanter / Enchantress 清除 Awareness；Weaver 使其他人物加入 the Devoured。
...
Alliance 君主每逢第 4 回合可被揭穿身份，一次性使其他城市 Political Agitation +100。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物与统治者`,text:`用于机械改造、治疗、建立设施及支援的知识资源；玩家单位取得后开放 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" />。MEKHANE 完成激活后，每回合 +1。`,acquisition:`研究 Schema、制造 <CrossReference name="Relic" href="?page=base-items#entry-mod-3591348120-i-mek-relic" meta="物品" text="Command +2。计入 MEKHANE 的封印进度，也是组装 Divine Machine 的材料。
持有时，每回合使所在地 Shadow 增加 0.033 个百分点；MEKHANE 的 Shadow 教义每降低一级，再增加 0.011 个百分点，最高至 100%。多件组件分别计算。" />、对应 Sermon、Council 与统治者研究行动。`,duration:`随获得和消费增减，最低 0。`},{id:`character-3591348120-t-mek-biomechanical`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Automaton`,category:`npc`,eligible:`<CrossReference name="Gatherer" href="#entry-character-3591348120-t-mek-automatonbasic" meta="角色修正" text="采集组件完成时填满全部空物品槽，并把组件送回据点储存。
持续与移除：持续保留；没有固定回合倒计时。" />、<CrossReference name="Sentinel" href="#entry-character-3591348120-t-mek-sentinel" meta="角色修正" text="Defence +5。守卫 Forge 时提供 Sentinel Presence，增加敌对行动 Complexity；主动开战自动结算后，幸存 Sentinel 打断 5 回合、幸存防守方打断 3 回合。
持续与移除：持续保留；没有固定回合倒计时。" />、<CrossReference name="Speaker" href="#entry-character-3591348120-t-mek-speaker" meta="角色修正" text="降低 Forge Profile、劝诱统治者和支援 Augmented Population；完成 Divert Attention 时 Divine Schema +1。
持续与移除：持续保留；没有固定回合倒计时。" /> 等机械化人物`,text:`不因衰老死亡，设为无灵魂并改为机械化物种；每回合 XP 清零、等级固定 1、可用技能点清零。`,acquisition:`<CrossReference name="Clockwork Virus" href="#entry-character-3591348120-t-mek-clockworkvirus" meta="角色修正" text="强度每回合 +2；完全 Enshadowed 的非玩家人物额外 +2。自主单位强度恰为 90 时打断 10 回合，达到 100 后转为 Gatherer。玩家感染者取得 Spread Clockwork Virus。
除休息外的普通任务意愿 −向下取整的强度/3；自我献祭意愿增加强度/2。
持续与移除：持续增长至转化。" /> 完成机械化；对应 Automaton 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-builder`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`The Builder`,category:`player`,eligible:`MEKHANE 指定的 Agent`,text:`Command +3，获得 Bumaro’s Warhammer；开放 <CrossReference name="Unified Church" href="?god=mekhane#entry-rt-mek-mekempire" meta="挑战" text="建立 Unified Church 帝国。Dark Empire 和平转化；其他国家不支持 Mekhanites 的领主可能发动内战。" />、Militancy 及召集遗物和战争相关仪式，可在 Congregation 制造 Cogwork 与 <CrossReference name="Maxwellist" href="#entry-character-3591348120-t-mek-allegiancemaxwellist" meta="角色修正" text="记录 Maxwellist 教派归属；当前完成制造的特质回调没有额外奖励结算。
持续与移除：持续保留；没有固定回合倒计时。" /> 组件。`,acquisition:`The Builder 神力。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-clockworkvirus`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Clockwork Virus`,category:`common`,eligible:`被感染的人物`,text:`强度每回合 +2；完全 Enshadowed 的非玩家人物额外 +2。自主单位强度恰为 90 时打断 10 回合，达到 100 后转为 <CrossReference name="Gatherer" href="#entry-character-3591348120-t-mek-automatonbasic" meta="角色修正" text="采集组件完成时填满全部空物品槽，并把组件送回据点储存。
持续与移除：持续保留；没有固定回合倒计时。" />。玩家感染者取得 Spread Clockwork Virus。
...
持续与移除：持续保留；没有固定回合倒计时。" /> 则更倾向摧毁机器。`,acquisition:`<CrossReference name="A Machine" href="?god=mekhane#entry-p-mek-machine" meta="神力" text="创建 A Machine，并解锁 Call of A Machine 与 Endless Noise。 神力消耗等于施放时的神力上限。" /> 地点或 Machine Effect 神力。`,duration:`强度降到 0 时解除；<CrossReference name="Grow the Machine" href="?god=mekhane#entry-ch-mek-growmachine" meta="挑战" text="完成时强度 +30。执行者已有 Machine Effect 时，该特质强度减半，并增加个人 Shadow 15 个百分点。交付组件界面的额外转化结果未找到可靠生效路径。" /> 将其减半，摧毁 <CrossReference name="A Machine" href="?god=mekhane#entry-p-mek-machine" meta="神力" text="创建 A Machine，并解锁 Call of A Machine 与 Endless Noise。 神力消耗等于施放时的神力上限。" /> 也可解除。`},{id:`character-3591348120-t-mek-maxwellist-awareness`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Data Blackout`,category:`common`,eligible:`<CrossReference name="Maxwellist" href="#entry-character-3591348120-t-mek-allegiancemaxwellist" meta="角色修正" text="记录 Maxwellist 教派归属；当前完成制造的特质回调没有额外奖励结算。
持续与移除：持续保留；没有固定回合倒计时。" /> 行动选中的人物`,text:`Awareness 持续压为 0，保存第一次施加前的数值。`,acquisition:`<CrossReference name="Infiltrator" href="#entry-character-3591348120-t-mek-infiltrator" meta="角色修正" text="使单位执行自动渗透与压低统治者 Awareness 的专门行为。
持续与移除：持续保留；没有固定回合倒计时。" /> 的 Awareness 干预或 <CrossReference name="Maxwellist" href="#entry-character-3591348120-t-mek-allegiancemaxwellist" meta="角色修正" text="记录 Maxwellist 教派归属；当前完成制造的特质回调没有额外奖励结算。
持续与移除：持续保留；没有固定回合倒计时。" /> 对应行动。`,duration:`30 回合；重复施加刷新时间，到期恢复原 Awareness。`},{id:`character-3591348120-t-mek-rotbolt`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Rotbolt Transformation`,category:`mobile`,eligible:`被 <CrossReference name="Rotbolt" href="?god=mekhane#entry-p-mek-rotbolt" meta="神力" text="创建 Rotbolt，并解锁 Accelerated Frequency 与 Biological Transfer。 神力消耗等于施放时的神力上限。" /> Transformation 选中的人物`,text:`每逢偶数回合 HP −1，Rest 意愿 −30。死亡于陆地时，已有 <CrossReference name="Rotbolt" href="?god=mekhane#entry-p-mek-rotbolt" meta="神力" text="创建 Rotbolt，并解锁 Accelerated Frequency 与 Biological Transfer。 神力消耗等于施放时的神力上限。" /> 的强度 +HP 上限×3；没有时创建 <CrossReference name="Rotbolt" href="?god=mekhane#entry-p-mek-rotbolt" meta="神力" text="创建 Rotbolt，并解锁 Accelerated Frequency 与 Biological Transfer。 神力消耗等于施放时的神力上限。" />。`,acquisition:`<CrossReference name="Rotbolt" href="?god=mekhane#entry-p-mek-rotbolt" meta="神力" text="创建 Rotbolt，并解锁 Accelerated Frequency 与 Biological Transfer。 神力消耗等于施放时的神力上限。" /> Consume 神力。`,duration:`持续至人物死亡。`},{id:`character-3591348120-t-mek-augmentbasicmight`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Artificial Limbs`,category:`player`,eligible:`能够执行 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" /> 的人物`,text:`Might +1。`,acquisition:`执行 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" /> 并选择此项改造。消耗 <CrossReference name="Divine Schema" href="#entry-character-3591348120-t-mek-divineschema" meta="角色修正" text="用于机械改造、治疗、建立设施及支援的知识资源；玩家单位取得后开放 Augment。MEKHANE 完成激活后，每回合 +1。
持续与移除：随获得和消费增减，最低 0。" />：首次 1，之后每多一项改造再增加 1。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-augmentbasiclore`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Arcane Engravings`,category:`player`,eligible:`能够执行 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" /> 的人物`,text:`Lore +1。`,acquisition:`执行 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" /> 并选择此项改造。消耗 <CrossReference name="Divine Schema" href="#entry-character-3591348120-t-mek-divineschema" meta="角色修正" text="用于机械改造、治疗、建立设施及支援的知识资源；玩家单位取得后开放 Augment。MEKHANE 完成激活后，每回合 +1。
...
教义还能提供专长、每回合 Gold +1、改变相关喜恶、为援助 Deep Ones 的行动提供 Basic Piece。制造 Relic 会取得 Divine Schema。
Alliance 君主每逢第 4 回合可被揭穿身份，一次性使其他城市 Political Agitation +100。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物`,text:`Attack +3。`,acquisition:`执行 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" /> 并选择此项改造。消耗 <CrossReference name="Divine Schema" href="#entry-character-3591348120-t-mek-divineschema" meta="角色修正" text="用于机械改造、治疗、建立设施及支援的知识资源；玩家单位取得后开放 Augment。MEKHANE 完成激活后，每回合 +1。
...
教义还能提供专长、每回合 Gold +1、改变相关喜恶、为援助 Deep Ones 的行动提供 Basic Piece。制造 Relic 会取得 Divine Schema。
Alliance 君主每逢第 4 回合可被揭穿身份，一次性使其他城市 Political Agitation +100。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物`,text:`Defence +3。`,acquisition:`执行 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" /> 并选择此项改造。消耗 <CrossReference name="Divine Schema" href="#entry-character-3591348120-t-mek-divineschema" meta="角色修正" text="用于机械改造、治疗、建立设施及支援的知识资源；玩家单位取得后开放 Augment。MEKHANE 完成激活后，每回合 +1。
...
持续与移除：知识保留到被 Study 消耗。" />。`,acquisition:`执行 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" /> 并选择此项改造。消耗 <CrossReference name="Divine Schema" href="#entry-character-3591348120-t-mek-divineschema" meta="角色修正" text="用于机械改造、治疗、建立设施及支援的知识资源；玩家单位取得后开放 Augment。MEKHANE 完成激活后，每回合 +1。
...
教义还能提供专长、每回合 Gold +1、改变相关喜恶、为援助 Deep Ones 的行动提供 Basic Piece。制造 Relic 会取得 Divine Schema。
Alliance 君主每逢第 4 回合可被揭穿身份，一次性使其他城市 Political Agitation +100。
持续与移除：持续保留；没有固定回合倒计时。" /> 单位`,text:`所在地 Security −1。`,acquisition:`<CrossReference name="Mekhanite" href="#entry-character-3591348120-t-mekhanite" meta="角色修正" text="获得机械教派身份、Divine Schema 和对应制造、传播、统治行动；不因衰老死亡，设为无灵魂。MEKHANE 完成激活后，Might、Lore、Intrigue、Command 各 +5。
教义还能提供专长、每回合 Gold +1、改变相关喜恶、为援助 Deep Ones 的行动提供 Basic Piece。制造 Relic 会取得 Divine Schema。
Alliance 君主每逢第 4 回合可被揭穿身份，一次性使其他城市 Political Agitation +100。
持续与移除：持续保留；没有固定回合倒计时。" /> 单位生成时的随机改造。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-augmentruler`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Augmentations / Mutations`,category:`ruler`,eligible:`<CrossReference name="Mekhanite" href="#entry-character-3591348120-t-mekhanite" meta="角色修正" text="获得机械教派身份、Divine Schema 和对应制造、传播、统治行动；不因衰老死亡，设为无灵魂。MEKHANE 完成激活后，Might、Lore、Intrigue、Command 各 +5。
教义还能提供专长、每回合 Gold +1、改变相关喜恶、为援助 Deep Ones 的行动提供 Basic Piece。制造 Relic 会取得 Divine Schema。
Alliance 君主每逢第 4 回合可被揭穿身份，一次性使其他城市 Political Agitation +100。
持续与移除：持续保留；没有固定回合倒计时。" /> 或 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 统治者`,text:`记录统治者已完成的自我改造次数；<CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 版本显示为 Mutations。后续研究与改造行动会读取此层数调整执行倾向。每次改造本身增加的属性直接计入人物基础属性。`,acquisition:`完成统治者 <CrossReference name="Augment" href="?god=mekhane#entry-rt-mek-augment" meta="挑战" text="消耗 Divine Schema 选择一项 Augmentation；费用随已有 Augmentation 数量增加。" /> 或 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> <CrossReference name="Mutate" href="?god=mekhane#entry-god-place-location-sub-mek-sarkictemple--place-task-3591348120-ch-mek-sarkicmutate" meta="兴趣点" text="消耗 2 Sarkic Insights，取得或升级一项 Sarkic Mutation。" /> 行动。`,duration:`每次对应改造增加层数，长期保留。`},{id:`character-3591348120-t-mek-augment-maxwellistconnection`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Noosphere Connection`,category:`npc`,eligible:`<CrossReference name="Maxwellist Intelligence" href="#entry-character-3591348120-t-mek-intelligence" meta="角色修正" text="从 Library 与 Geomantic Locus 获得 Divine Schema，转为 Arcane Mechanisms。无灵魂、免疫衰老；XP 与技能点保持 0，等级固定为转化时的等级。
持续与移除：持续保留；没有固定回合倒计时。" />；<CrossReference name="Maxwellist" href="#entry-character-3591348120-t-mek-allegiancemaxwellist" meta="角色修正" text="记录 Maxwellist 教派归属；当前完成制造的特质回调没有额外奖励结算。
持续与移除：持续保留；没有固定回合倒计时。" /> Agent 也使用相同特质`,text:`允许在已渗透地点建立 <CrossReference name="Maxwellist Connection" href="?god=mekhane#entry-pr-mek-connection" meta="地点修正" text="把当地人口接入 Noosphere，供 Intelligence 通过 Harvest Information 收集 Piece。
正常创建时直接处于强度上限；只有强度处于 0 与上限之间时才运行恢复检查。" />。`,acquisition:`<CrossReference name="Maxwellist" href="#entry-character-3591348120-t-mek-allegiancemaxwellist" meta="角色修正" text="记录 Maxwellist 教派归属；当前完成制造的特质回调没有额外奖励结算。
持续与移除：持续保留；没有固定回合倒计时。" /> Construct 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-allegiancemaxwellist`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Maxwellist`,category:`common`,eligible:`Maxwellist 据点关联人物`,text:`记录 Maxwellist 教派归属；当前完成制造的特质回调没有额外奖励结算。`,acquisition:`与 Maxwellist Hub 的人物归属流程关联。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-allegianceorthodox`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Cogwork Orthodox`,category:`common`,eligible:`Cogwork Orthodox 据点关联人物与 Legate`,text:`记录 Cogwork Orthodox 教派归属；当前完成 Cogwork 制造的特质回调没有额外奖励结算。`,acquisition:`<CrossReference name="Orthodox Forge" href="?god=mekhane#entry-sub-mek-forge" meta="兴趣点" text="由 Standardization 建立的 Cogwork Orthodoxy 制造中心，开放 Clockwork Mechanism、Cogwork Relic 与 Automatons，并具有 Production。
...
持续与移除：持续保留；没有固定回合倒计时。" /> Infiltrator`,text:`使单位执行自动渗透与压低统治者 Awareness 的专门行为。`,acquisition:`<CrossReference name="Maxwellist" href="#entry-character-3591348120-t-mek-allegiancemaxwellist" meta="角色修正" text="记录 Maxwellist 教派归属；当前完成制造的特质回调没有额外奖励结算。
持续与移除：持续保留；没有固定回合倒计时。" /> Infiltrator 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-intelligence`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Maxwellist Intelligence`,category:`npc`,eligible:`<CrossReference name="Maxwellist" href="#entry-character-3591348120-t-mek-allegiancemaxwellist" meta="角色修正" text="记录 Maxwellist 教派归属；当前完成制造的特质回调没有额外奖励结算。
持续与移除：持续保留；没有固定回合倒计时。" /> Construct 与被上传的人物`,text:`从 <CrossReference name="Library" href="?page=points-of-interest#entry-location-sub-library" meta="兴趣点" text="每回合有 2% 概率生成 Arcane Secret；当地已有 Arcane Secret 时不重复建立。生成的秘密初始强度为 50。提供 Research Arcane Secret；Iastur 存在且 Library 未被渗透时，额外提供 floor(神力上限÷2)，则神力清零；否则我方所有可控人物单位各增加 Profile 5、Menace 5。之后在执行者所在地留下 Laughing King's Tome (Asleep)。上限为奇数时，比较阈值先向下取整。
执行地点：Library
Lore
Complexity: 5
Profile: 1000
...
持续与移除：随获得和消费增减，最低 0。" /> +1。`,acquisition:`<CrossReference name="Orthodox Forge" href="?god=mekhane#entry-sub-mek-forge" meta="兴趣点" text="由 Standardization 建立的 Cogwork Orthodoxy 制造中心，开放 Clockwork Mechanism、Cogwork Relic 与 Automatons，并具有 Production。
...
持续与移除：随获得和消费增减，最低 0。" /> +1。`,acquisition:`Speaker 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-sarkic`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Sarkic`,category:`common`,eligible:`Sarkic 英雄、教士与统治者`,text:`免疫衰老，取得时清空 Shadow、获得 <CrossReference name="Sarkic Insights" href="#entry-character-3591348120-t-sarkic-secrets" meta="角色修正" text="用于突变和教派行动的知识资源；完成 Learn Secret 时额外取得 1。
持续与移除：获得和消费时增减，最低 0。" />，并等概率得到 <CrossReference name="Clawed Hands" href="#entry-character-3591348120-t-mek-sarkic-mutationattack" meta="角色修正" text="Attack +2+等级；首次获得等级为 0。
持续与移除：持续保留；没有固定回合倒计时。" /> 或 <CrossReference name="Armored Skin" href="#entry-character-3591348120-t-mek-sarkic-mutationdefense" meta="角色修正" text="Defence +2+等级；首次获得等级为 0。
持续与移除：持续保留；没有固定回合倒计时。" />。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 <CrossReference name="Mekhanite" href="#entry-character-3591348120-t-mekhanite" meta="角色修正" text="获得机械教派身份、Divine Schema 和对应制造、传播、统治行动；不因衰老死亡，设为无灵魂。MEKHANE 完成激活后，Might、Lore、Intrigue、Command 各 +5。
教义还能提供专长、每回合 Gold +1、改变相关喜恶、为援助 Deep Ones 的行动提供 Basic Piece。制造 Relic 会取得 Divine Schema。
Alliance 君主每逢第 4 回合可被揭穿身份，一次性使其他城市 Political Agitation +100。
持续与移除：持续保留；没有固定回合倒计时。" /> 的好感。统治者开放研究与突变行动。
...
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物与统治者`,text:`用于突变和教派行动的知识资源；完成 Learn Secret 时额外取得 1。`,acquisition:`研究 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" />、探索其墓地、统治者研究及 <CrossReference name="Growing Knowledge" href="#entry-character-3591348120-t-mek-sarkic-mutationinsights" meta="角色修正" text="每 5 回合获得 1 Sarkic Insight。
持续与移除：持续保留；没有固定回合倒计时。" />。`,duration:`获得和消费时增减，最低 0。`},{id:`character-3591348120-t-sarkic-truth`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Sarkic Truth`,category:`mobile`,eligible:`合成高阶真理的 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物`,text:`高阶 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 资源，用于进一步突变与特殊行动。`,acquisition:`将 <CrossReference name="Sarkic Insights" href="#entry-character-3591348120-t-sarkic-secrets" meta="角色修正" text="用于突变和教派行动的知识资源；完成 Learn Secret 时额外取得 1。
持续与移除：获得和消费时增减，最低 0。" /> 合成为 Truth 的对应行动。`,duration:`储存到被消费。`},{id:`character-3591348120-t-sarkic-grandkarcist`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Grand Karcist`,category:`npc`,eligible:`Grand <CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" />`,text:`免疫衰老；主导世界范围的 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 传播及最终仪式。完成 Study <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 时，已有 <CrossReference name="Sarkic Insights" href="#entry-character-3591348120-t-sarkic-secrets" meta="角色修正" text="用于突变和教派行动的知识资源；完成 Learn Secret 时额外取得 1。
持续与移除：获得和消费时增减，最低 0。" /> 额外 +1。`,acquisition:`Grand <CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-sarkic-karcist`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Karcist`,category:`npc`,eligible:`Karcist`,text:`免疫衰老；取得 <CrossReference name="Growing Knowledge" href="#entry-character-3591348120-t-mek-sarkic-mutationinsights" meta="角色修正" text="每 5 回合获得 1 Sarkic Insight。
持续与移除：持续保留；没有固定回合倒计时。" />，并等概率获得 Regeneration、<CrossReference name="Blood Absorbtion" href="#entry-character-3591348120-t-mek-sarkic-mutationhpkill" meta="角色修正" text="战斗死亡事件回调结算时恢复满 HP，通常随击杀对手触发。
持续与移除：持续保留；没有固定回合倒计时。" />、<CrossReference name="Anti-Memetic Pheromones" href="#entry-character-3591348120-t-mek-sarkic-mutationprofilemenace" meta="角色修正" text="每回合 Profile、Menace 各减少同地其他有人物身份的单位数量。
持续与移除：持续保留；没有固定回合倒计时。" />、<CrossReference name="Retractive Wings" href="#entry-character-3591348120-t-mek-sarkic-mutationspeed" meta="角色修正" text="每回合首次移动后，将已用移动点清零。
持续与移除：持续保留；没有固定回合倒计时。" /> 或 <CrossReference name="Adaptive Defenses" href="#entry-character-3591348120-t-mek-sarkic-mutationdefenseminions" meta="角色修正" text="实际提高 Attack，数值等于自身随从中最高的当前 Defence。
持续与移除：持续保留；没有固定回合倒计时。" /> 之一。完成 Study <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 时，已有 <CrossReference name="Sarkic Insights" href="#entry-character-3591348120-t-sarkic-secrets" meta="角色修正" text="用于突变和教派行动的知识资源；完成 Learn Secret 时额外取得 1。
持续与移除：获得和消费时增减，最低 0。" /> 额外 +1。`,acquisition:`Karcist 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-sarkic-mutationattack`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Clawed Hands`,category:`mobile`,eligible:`<CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物`,text:`Attack +2+等级；首次获得等级为 0。`,acquisition:`首次改信 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 或执行 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> <CrossReference name="Mutate" href="?god=mekhane#entry-god-place-location-sub-mek-sarkictemple--place-task-3591348120-ch-mek-sarkicmutate" meta="兴趣点" text="消耗 2 Sarkic Insights，取得或升级一项 Sarkic Mutation。" />。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-sarkic-mutationdefense`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Armored Skin`,category:`mobile`,eligible:`<CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 人物`,text:`Defence +2+等级；首次获得等级为 0。`,acquisition:`首次改信 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 或执行 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> <CrossReference name="Mutate" href="?god=mekhane#entry-god-place-location-sub-mek-sarkictemple--place-task-3591348120-ch-mek-sarkicmutate" meta="兴趣点" text="消耗 2 Sarkic Insights，取得或升级一项 Sarkic Mutation。" />。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-sarkic-mutationhp`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Regeneration`,category:`npc`,eligible:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" />`,text:`每逢偶数回合恢复 1 HP，不超过上限。`,acquisition:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时的随机突变。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-sarkic-mutationhpkill`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Blood Absorbtion`,category:`npc`,eligible:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" />`,text:`战斗死亡事件回调结算时恢复满 HP，通常随击杀对手触发。`,acquisition:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时的随机突变。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-sarkic-mutationprofilemenace`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Anti-Memetic Pheromones`,category:`npc`,eligible:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" />`,text:`每回合 Profile、Menace 各减少同地其他有人物身份的单位数量。`,acquisition:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时的随机突变。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-sarkic-mutationspeed`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Retractive Wings`,category:`npc`,eligible:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" />`,text:`每回合首次移动后，将已用移动点清零。`,acquisition:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时的随机突变。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-sarkic-mutationdefenseminions`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Adaptive Defenses`,category:`npc`,eligible:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" />`,text:`实际提高 Attack，数值等于自身随从中最高的当前 Defence。`,acquisition:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时的随机突变。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-t-mek-sarkic-mutationinsights`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Growing Knowledge`,category:`npc`,eligible:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" />`,text:`每 5 回合获得 1 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> Insight。`,acquisition:`<CrossReference name="Karcist" href="#entry-character-3591348120-t-sarkic-karcist" meta="角色修正" text="免疫衰老；取得 Growing Knowledge，并等概率获得 Regeneration、Blood Absorbtion、Anti-Memetic Pheromones、Retractive Wings 或 Adaptive Defenses 之一。完成 Study Sarkic 时，已有 Sarkic Insights 额外 +1。
持续与移除：持续保留；没有固定回合倒计时。" /> 生成时自带。`,duration:`持续保留；没有固定回合倒计时。`},{id:`character-3591348120-temporary-sarkicstatboost`,source:`3591348120`,sourceName:`MEKHANE The Broken God`,name:`Sarkic Prayer · Might`,category:`mobile`,eligible:`执行 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> Prayer 的 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> 角色`,text:`Might +1。`,acquisition:`在提供该行动的 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> Locus 完成 <CrossReference name="Sarkic" href="#entry-character-3591348120-t-sarkic" meta="角色修正" text="免疫衰老，取得时清空 Shadow、获得 Sarkic Insights，并等概率得到 Clawed Hands 或 Armored Skin。此后每回合 Shadow −10 个百分点，提高对 Sarkic 的偏好并降低对 Mekhanite 的好感。统治者开放研究与突变行动。
I. Applied Mutations 尚未启用时，回合结算清零 Profile 与 Menace。IV. Weakened Enemies 启用时，Attack、Defence 各 −5。
持续与移除：持续保留；没有固定回合倒计时。" /> Prayer。`,duration:`25 回合。`},{id:`character-3647343379-t-fc-imperial`,source:`3647343379`,sourceName:`Villikos, the First Claimant`,name:`Imperial Blood`,category:`common`,eligible:`Villikos 帝国血脉的英雄与统治者`,text:`Awareness 每回合归零；获得时对 Ambition 的偏好设为 2。地方统治者逐步提高对 Cruel、Gold、Danger、Combat 的偏好，并可争夺更高职位、清洗家族和安插统治者。
...
达到 300 时强度回落到 150；若当地是人类聚居地且尚无 Madness Effect，则触发 Madness Crisis，等概率留下六种长期效果之一。" /> 每回合 +0.5；具有 <CrossReference name="Call of the Abyss" href="#entry-character-base-t-calloftheabyss" meta="角色修正" text="强度每逢偶数回合 +1。自主人物可用 Maintain Humanity 将强度清零，但增加 3 Exhaustion；强度大于 0 时可执行 Descend into the Sea，转化为自主 Deep One。玩家 Agent 接受转化后不再受玩家控制，并释放一个 Agent 名额。
持续与移除：Chosen One 会自动清除此状态；其他人物通过专门行动抵抗或完成转化。" /> 时，已有 <CrossReference name="Deep One Cult" href="?god=aberrant-metal#entry-deep-one-cult" meta="地点修正" text="在聚居地发展的 Deep One 秘密崇拜。Security 修正为 −⌊（50+强度）÷100⌋。强度超过 100 后，每回合增加强度 ÷1000 个百分点的 Shadow；当地 Madness 低于 Cult 强度 −100 时，每回合增加 1.5 Madness。
