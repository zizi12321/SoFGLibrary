...
单次候选检查概率：100%。" /> 的对应选项获得。`,duration:`各项从获得时分别倒计时，持续回合见上；到期移除对应属性变化。`},{id:`character-3261852980-event-nobleconnections`,source:`3261852980`,sourceName:`Event Pack Redux`,name:`Noble Connections`,category:`player`,eligible:`满足事件条件的 Human、Elf 或 Orc 玩家 Agent`,text:`在 City 执行行动时 Security −1。`,acquisition:`Noble Connections 事件选择 Hand the social climber the ladder。事件要求当地有对该人物持正面态度的统治者、Agent 的 Menace <20，且本局尚未通过此事件获得。`}];m.push(...o);var h=e(),g=Array.from(new Set(m.map(e=>e.source))).map(e=>({id:e,name:m.find(t=>t.source===e).sourceName,groups:Object.entries(p).map(([t,n])=>({id:`characters-`+e+`-`+t,name:n,items:m.filter(n=>n.source===e&&n.category===t)})).filter(e=>e.items.length)})),_={id:`character-modifiers`,assetDir:``,autoLink:!1,powers:[],sections:g.flatMap(e=>e.groups.map(e=>({id:e.id,title:`角色特质`,items:e.items})))},v=m.map(e=>`entry-`+e.id),y=g.map(e=>({name:e.name,entries:e.groups.map(e=>({href:`#`+e.id,label:e.name}))})),b=m.filter(e=>e.source===`base`).length;function x(){let{sidebarHidden:e,setSidebarHidden:o,closeMobileSidebar:u,onSidebarClick:p}=t(),[x,S]=(0,f.useState)(new Set),C=e=>S(t=>new Set(t).add(e)),w=e=>S(t=>{let n=new Set(t);return n.has(e)?n.delete(e):n.add(e),n}),T=c(C);return(0,h.jsxs)(`main`,{className:`site-shell base-modifiers-theme character-modifiers-theme`+(e?` sidebar-hidden`:``),onClick:T,children:[(0,h.jsx)(d,{hidden:e,onClose:u}),(0,h.jsxs)(`aside`,{className:`sidebar`,onClick:p,children:[(0,h.jsxs)(`div`,{className:`sidebar-head`,children:[(0,h.jsxs)(`div`,{className:`sidebar-brand`,children:[(0,h.jsx)(`span`,{className:`brand-mark`,children:(0,h.jsx)(l,{size:17})}),(0,h.jsxs)(`span`,{children:[(0,h.jsx)(`b`,{children:`角色特质`}),(0,h.jsx)(`small`,{children:`其他信息`})]})]}),(0,h.jsx)(`button`,{className:`sidebar-toggle`,type:`button`,"aria-expanded":!e,"aria-label":e?`展开侧边栏`:`收起侧边栏`,onClick:()=>o(e=>!e),children:e?(0,h.jsx)(a,{size:17}):(0,h.jsx)(r,{size:17})})]}),(0,h.jsx)(`a`,{className:`sidebar-index-link`,href:`./`,children:`← 返回索引页`}),(0,h.jsxs)(`div`,{className:`sidebar-bulk`,children:[(0,h.jsx)(`button`,{type:`button`,onClick:()=>S(new Set(v)),children:`全部展开`}),(0,h.jsx)(`button`,{type:`button`,onClick:()=>S(new Set),children:`全部收起`})]}),(0,h.jsx)(i,{groups:y,label:`角色特质导航`})]}),(0,h.jsxs)(`div`,{className:`content-shell`,children:[(0,h.jsxs)(`header`,{id:`top`,className:`modifier-library-header`,children:[(0,h.jsx)(`h1`,{children:`角色特质`}),(0,h.jsxs)(`p`,{children:[`本体 `,b,` 项，Mod `,m.length-b,` 项。收录人物的可学习能力、特质、诅咒、临时状态及随从能力，按能够获得它们的单位类别分类。`]}),(0,h.jsx)(`p`,{children:`不收录神祇相关特质及单个玩家 Agent 独有的能力。各 Mod 分别列出，使用当前有效版本。`})]}),g.map((e,t)=>(0,h.jsxs)(`section`,{className:`section character-source`,id:`character-source-`+e.id,children:[(0,h.jsxs)(`div`,{className:`plain-heading`,children:[(0,h.jsxs)(`p`,{className:`section-index`,children:[String(t+1).padStart(2,`0`),` / `,e.id===`base`?`游戏本体`:`Mod`]}),(0,h.jsx)(`h2`,{children:e.name})]}),e.groups.map(e=>(0,h.jsxs)(`div`,{className:`character-category`,id:e.id,children:[(0,h.jsxs)(`h3`,{children:[e.name,(0,h.jsx)(`small`,{children:e.items.length})]}),(0,h.jsx)(`div`,{className:`expandable-table`,children:e.items.map(e=>{let t=`entry-`+e.id;return(0,h.jsxs)(s,{config:_,entryId:t,name:e.name,open:x.has(t),onToggle:w,children:[e.levels&&(0,h.jsxs)(`small`,{className:`tenet-range`,children:[`等级范围：`,e.levels]}),(0,h.jsxs)(`div`,{className:`expanded-section`,children:[(0,h.jsx)(`h4`,{children:`适用人物`}),(0,h.jsx)(`p`,{children:(0,h.jsx)(n,{config:_,text:e.eligible,exclude:e.name})})]}),(0,h.jsxs)(`div`,{className:`expanded-section`,children:[(0,h.jsx)(`h4`,{children:`作用`}),(0,h.jsx)(`p`,{children:(0,h.jsx)(n,{config:_,text:e.text,exclude:e.name})})]}),(0,h.jsxs)(`div`,{className:`expanded-section`,children:[(0,h.jsx)(`h4`,{children:`获取方式`}),(0,h.jsx)(`p`,{children:(0,h.jsx)(n,{config:_,text:e.acquisition,exclude:e.name})})]}),e.duration&&(0,h.jsxs)(`div`,{className:`expanded-section`,children:[(0,h.jsx)(`h4`,{children:`持续与移除`}),(0,h.jsx)(`p`,{children:(0,h.jsx)(n,{config:_,text:e.duration,exclude:e.name})})]})]},t)})})]},e.id))]},e.id)),(0,h.jsx)(`footer`,{className:`archive-footer`,children:(0,h.jsx)(`a`,{className:`sidebar-index-link`,href:`./`,children:`← 返回索引页`})})]})]})}export{x as default};