...
const heroTasks: DetailItem[] = [
  { name: "Purge Fleeting Servant", image: "power-fleeting-servant.png", meta: "Intrigue", statLine: "复杂度 5　暴露度 30　威胁度 50　经验 12（标准难度）", preferenceText: "任务带有 Shadow 负面标签：厌恶或极端厌恶 Shadow 的英雄更愿意处理它；喜欢 Shadow 的英雄意愿降低。除此之外没有专属固定意愿加值。", text: "英雄清除所在地的一项 Fleeting Servant 修正。任务每回合按 Intrigue 推进，最低也有 1 点进度；完成任务本身只移除诱饵，不会产生额外地点收益。" },
];
