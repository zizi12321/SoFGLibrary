...
const locationModifiers: DetailItem[] = [
  ...
  { name: "Madness", image: "madness.png", baseGame: true, modifierChange: { natural: "", external: "<CrossReference name=\"Stories Told In Dreams\" href=\"index.html?god=iastur#entry-stories-told-in-dreams\" /> 一次性增加 50。\n<CrossReference name=\"Laughing King's Tome\" href=\"index.html?god=iastur#entry-laughing-king-s-tome\" /> 与 <CrossReference name=\"Hysterical Tome\" href=\"index.html?god=iastur#entry-hysterical-tome-modifier\" /> 在人类聚居地每回合各增加 3。\n<CrossReference name=\"Maddening Tongues\" href=\"index.html?god=iastur#entry-maddening-tongues\" /> 在人类聚居地每回合增加 1。\n<CrossReference name=\"Everyone Shall Play\" href=\"index.html?god=iastur#entry-everyone-shall-play\" /> 使未封印 Tome 被非玩家人物携带时每回合额外增加 3，并使 <CrossReference name=\"Laughing King's Tome\" href=\"index.html?god=iastur#entry-laughing-king-s-tome\" /> 向相邻人类聚居地每回合增加 1。\n<CrossReference name=\"Neurotoxins\" /> 每消耗 1 点 Vinerva's Gift 增加 2 点，最多把地点推到 300。\n<CrossReference name=\"Cure Madness\" href=\"index.html?god=iastur#entry-cure-madness\" /> 完成时减少 25。\n达到 300 时触发一次 <CrossReference name=\"Madness Crisis\" href=\"index.html?god=iastur#entry-madness-crisis\" />，强度回落到 150。" }, text: "游戏本体地点修正。每 1 点强度造成 −0.003 Prosperity；超过 100 后增加 Unrest，并逐步侵蚀当地统治者的 Sanity。Madness 达到 300 时触发一次随机 <CrossReference name=\"Madness Crisis\" href=\"index.html?god=iastur#entry-madness-crisis\" />，留下六种长期效果之一，然后强度回落到 150。" },
  ...
  { name: "Gift of Nectar", image: "grove-nectar.png", initialValue: "创建时强度 50。", modifierChange: { natural: "每回合强度 −1.25。", external: "<CrossReference name=\"Harvest Nectar\" /> 完成时留下该短期修正；它和 Vinerva's Gift 一样不触发普通地点危机。" }, text: "短期地点修正：食物产出提高 200%，并额外提供 50 平坦食物。" },
...
const relations: Record<string, { sources?: Relation[]; effects?: Relation[] }> = {
  ...
  "Madness": { sources: [{ name: "Stories Told In Dreams", href: "index.html?god=iastur#entry-stories-told-in-dreams", meta: "Iastur · 神力" }, { name: "Laughing King's Tome", href: "index.html?god=iastur#entry-laughing-king-s-tome", meta: "Iastur · 地点修正" }, { name: "Hysterical Tome", href: "index.html?god=iastur#entry-hysterical-tome-modifier", meta: "Iastur · 地点修正" }, { name: "Maddening Tongues", href: "index.html?god=iastur#entry-maddening-tongues", meta: "Iastur · 能力" }, { name: "Everyone Shall Play", href: "index.html?god=iastur#entry-everyone-shall-play", meta: "Iastur · 神力" }, { name: "Neurotoxins", href: "#entry-neurotoxins" }], effects: [{ name: "Cure Madness", href: "index.html?god=iastur#entry-cure-madness", meta: "本体挑战" }, { name: "Madness Crisis", href: "index.html?god=iastur#entry-madness-crisis", meta: "本体事件" }] },
